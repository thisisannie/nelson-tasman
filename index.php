        ...
        <section class="pattern">
            <div class="content">
                ...
                <ul>
                    ...
                    <li>Better reflect the ‘Better business, together’ proposition</li>
                </ul>
                <p>To portray the "Better Business, Together" brand proposition we suggested an interactive homepage which serves the user with a custom selection of content based on their reason for visiting the site - as captured in a drop down form at the top of the homepage. This allowed Orbit to put their best foot forward when assisting every site visitor.</p>
